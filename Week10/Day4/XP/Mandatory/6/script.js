...
class Mamal extends Animal {
  constructor(name, type, color, soundByAnimal) {
    super(name, type, color); // call the super class constructor and pass in the name parameter
    // Add a new property
  ...
  sound() {
    console.log(
      `Details of the animal: ${this.name}, a ${this.type}, of ${this.color} appearance, and it says ${this.soundByAnimal}`
    );
  }
}

let farmerCow = new Mamal("Lilly", "Cow", "brown and white", "Mooooo");
